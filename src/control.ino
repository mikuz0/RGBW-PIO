...
Описание управления
КНОПКА
1. Одно нажатие кнопки - включить, выключить
2. Два нажатия кнопки  - вперед по прессатам или цветам.
3. Три нажатия кнопки - назад по прессетам или цветам.
4. Нажать и удерживать кнопку  - меняет направление регулировки яркости
5. Много кликов - меняет яркость , в зависимости от направления.

ЭНКОДЕР

1. Один клик - включить дисплей
2. Вращение влево - 
3. Вращение вправо - 
4. Нажать и вращать влево - 
5. Нажать и вращать вправо ------------------
