...
// ================ НАСТРОЙКИ ================
// ------ Схема ------
#define WIRING_VERSION 0    // тип схемы. 0 - обычная для моей разработки, 1 - печатная плата Гайвера
...
// ------ Драйвер ------
#define HIGH_FREQUENCY 0    // 0 - 490 Гц, 1 - 7.8 кГц, 2 - 31.4 кГц, 3 - ручная настройка
...
// --------- Цвет ---------
#define MIN_PWM 5           // минимальный сигнал PWM
